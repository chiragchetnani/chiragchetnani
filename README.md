...
## Overview
- CS student at JECRC University, graduating 2024
- Proficient in Python, C++, HTML/CSS, SQL, TensorFlow, Keras, PyTorch
- Real-world application projects: Amazon product length prediction, sentiment analysis, Amazon Go store replication
- Notable projects: Healthtech app, personal loan prediction
- Active in tech communities: Silver-Campus Ambassador (E-Cell, IIT Bombay), Xebia Ambassador

## Achievements 🏆
- Runner-up: JECRC Ideathon 2021, IIT Delhi Game Jam 2022
- Certifications: Google Cloud, E-Cell, IIT Bombay Ambassador

## GitHub Highlights 🚀
- Reflects academic journey, projects, and ML initiatives
- [GitHub Portfolio](http://chiragchetnani.github.io/Personal-portfolio/)

## Location 🌍
- Based in Jaipur, India

## Current Projects 🚀
- Illuvium Analysis and Ethereum Price prediction for January 2024: [illuvium.streamlit.app](http://illuvium.streamlit.app)
- Learning Crypto Market Analysis, open to ML and Research collaboration
